class Employee:
    ...
    def __init__(self, employee_id=0, dep_id=0, supervisor_id=0, name="", funds=0, is_dep_head=False, is_benco=False, requests=None):
    ...
    def json_parse(json):
        ...
        employee.supervisor_id = json["supervisor_id"] if "supervisorId" in json else 0
